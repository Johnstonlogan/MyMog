  ...
  return (
    ...
    <div className="home-container">
      <div className="home-left">
        <HomeCard content={`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        ...
        dictumst.`} header={"Create Tournament"} button={"Create Tournament"} />
      ...
      <HomeCard content={`Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
        ...
        mauris eu nibh euismod gravida. Duis ac tellus et risus vulputate
        vehicula. In hac habitasse platea
        dictumst.`} header={"Join existing Tournament"} button={"Join Tournament"} />
